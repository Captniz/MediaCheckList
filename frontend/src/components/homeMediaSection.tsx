...
const HomeMediaSect = ({ children, defaultCss,itemsFound }:{children:React.ReactNode,defaultCss:string,itemsFound:number}) => {
  return (
    <div className={defaultCss +"-home-media-sect sect-support"}>
      <div className="sect-header ">
        <div className="sect-title-space">
          ...
          <h3 className='sect-found'> Found {itemsFound} {defaultCss}</h3>
        </div>
